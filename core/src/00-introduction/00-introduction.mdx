...
> > Community License](http://www.openlegendrpg.com/community-license) allows for
...
| is less than the Challenge Rating,      | the player succeeds with a twist. <br /> - OR - <br /> _the player fails but the story progresses_. (GM's Choice) |
