...
- **Multi-Target Attack Specialist (tier equals NPC level, max 5):** When you choose this feat, you must decide to focus in area, ranged, or melee attacks. For each tier, you reduce the disadvantage penalty associated with multi-targeting for your chosen attack type by 1.
...
When they reach the town of Haven, the survivors find the gates closed. The guards inform them that the Overseer has placed a blockade on all outsiders due to reports of an outbreak of a new strain of Virus Z. With a few smooth words, Wendell manages to get the Overseer to come to the gate. Now he must convince the guard that the group isn't infected and that they would be a valuable asset to the town.
...
Gizmo attempts to bypass a lock on a mundane door with his Pocket Matter Disintegration Device. He focuses the beam on the lock and rolls to remove it from  existence.
