...
-   **Major Change to Evasion / Resilience Defense** - due to the words `Resilience` and `Toughness` being too similar, `Resilience` (formerlyl `Evasion`) is not called `Guard`.
